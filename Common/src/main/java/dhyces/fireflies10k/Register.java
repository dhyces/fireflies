...
public class Register {
    ...
    public static final Supplier<Item> FIREFLY_IN_A_BOTTLE = ITEM_REG_PROVIDER.register("firefly_in_a_bottle", () -> new StandingAndWallBlockItem(FIREFLY_LANTERN_BLOCK.get(), WALL_FIREFLY_LANTERN_BLOCK.get(),  new Item.Properties().stacksTo(16)));
